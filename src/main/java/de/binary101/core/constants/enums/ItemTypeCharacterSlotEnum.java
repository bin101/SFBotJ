...
public enum ItemTypeCharacterSlotEnum {
	None(0), Helmet(1), Torso(2), Gloves(3), Shoes(4), Amulet(5), Belt(6), Ring(
			7), Talisman(8), Weapon(9), Shield(10), Potion(12);
	...
	public static ItemTypeCharacterSlotEnum fromItemTypeEnum(ItemTypeEnum value) {
		...
		for (ItemTypeCharacterSlotEnum item : ItemTypeCharacterSlotEnum
				.values()) {
