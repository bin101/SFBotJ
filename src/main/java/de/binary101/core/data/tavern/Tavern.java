...
public class Tavern {
	...
	public void updateTavern(Account account, Long[] ownplayersave) {
		...
		this.availableQuests.set(0, new Quest(
				1,
				ownplayersave[OwnPlayerSaveEnum.Quest_1_Duration.getId()].intValue(),
				ownplayersave[OwnPlayerSaveEnum.Quest_1_Silver.getId()].intValue(),
				ownplayersave[OwnPlayerSaveEnum.Quest_1_Exp.getId()].intValue(),
				Item.createItem(ownplayersave, OwnPlayerSaveEnum.Quest_1_ItemStart.getId(), -1),
				ownplayersave[OwnPlayerSaveEnum.Quest_1_MonsterID.getId()].intValue()));
		
		this.availableQuests.set(1, new Quest(
				2,
				ownplayersave[OwnPlayerSaveEnum.Quest_2_Duration.getId()].intValue(),
				ownplayersave[OwnPlayerSaveEnum.Quest_2_Silver.getId()].intValue(),
				ownplayersave[OwnPlayerSaveEnum.Quest_2_Exp.getId()].intValue(),
				Item.createItem(ownplayersave, OwnPlayerSaveEnum.Quest_2_ItemStart.getId(), -1),
				ownplayersave[OwnPlayerSaveEnum.Quest_2_MonsterID.getId()].intValue()));
		
		this.availableQuests.set(2, new Quest(
				3,
				ownplayersave[OwnPlayerSaveEnum.Quest_3_Duration.getId()].intValue(),
				ownplayersave[OwnPlayerSaveEnum.Quest_3_Silver.getId()].intValue(),
				ownplayersave[OwnPlayerSaveEnum.Quest_3_Exp.getId()].intValue(),
				Item.createItem(ownplayersave, OwnPlayerSaveEnum.Quest_3_ItemStart.getId(), -1),
